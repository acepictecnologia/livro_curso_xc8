...
# 1 "./../Bibliotecas/LCD4b.h" 1
# 20 "./../Bibliotecas/LCD4b.h"
void lcd_ini(void);
...
int T0_500ms = 0, T1_1000ms;
int conta_t0 = 0, conta_t1;
char bufferLCD[16];


void __attribute__((picinterrupt(("low_priority")))) int_TIMERS(void)
{
    if (TMR0IF)
    {
        T0_500ms++;
...
void main(void)
{
    ...
    while(1)
    {
        ...
        sprintf(bufferLCD, "%02d", conta_t1);
