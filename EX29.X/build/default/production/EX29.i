...
void __attribute__((picinterrupt(("low_priority")))) int_TMR0(void)
{

    if (TMR0IF)
    {
      sel_digito++;
      if (sel_digito>4) sel_digito = 1;
...
# 134 "EX29.c"
    ...
    while(1)
    {
        ...
        volt = ((unsigned long)adc * 5000) / 1023;


        seleciona_7seg((unsigned int)volt);
