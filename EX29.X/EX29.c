...
unsigned int sel_digito = 0;         //Variável de seleção de dígitos
unsigned int dig1, dig2, dig3, dig4; /*Variáveis para armazenamento do cálculo de 
                                       dígitos*/
unsigned int adc = 0;                //Variável de armazenamento da conversão A/D
unsigned long volt = 0;		//Variável para conversão em Volts
...
void main(void) {
    ...
    while(1)
    {
        ...
        seleciona_7seg((unsigned int)volt); 	/*Chama a função selecionar_7seg 
  atribuindo a variável conta*/  
